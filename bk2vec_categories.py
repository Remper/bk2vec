...
with graph.as_default():
  ...
  #with tf.device('/cpu:0'):
    ...
    #  pages_parsed += 1
    # for i in pages[page]:
    #    true_indices.append([page, i])
    #  if pages_parsed % 1000000 == 0:
    #    print("  " + str(pages_parsed // 1000000) + "m pages converted")
    #category_mask = tf.SparseTensor(indices=true_indices, values=[True]*value_count,
